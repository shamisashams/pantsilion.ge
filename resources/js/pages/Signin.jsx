...
const Signin = ({seo}) => {
    ...
    return <Layout seo={seo}><div className="bg-zinc-100">
        <div className="wrapper max-w-md py-52 text-center">
            <div className="sm:text-5xl text-3xl bold mb-10">Log in</div>
            ...
            <p className="my-6">Don't have an account?  <Link href={route('client.registration.index')} className="text-sky-600 underline"> Sign up</Link></p>
        </div>
    </div></Layout>
}
