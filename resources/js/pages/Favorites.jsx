        ...
        <Layout seo={seo}>
            <div className="wrapper py-40">
                <div className="text-4xl bold mb-10">
                    {__("client.favorites_title", localizations)}
                </div>
                    ...
                    return item.product ? (
                        <div
                            ...
                            className={`flex justify-between items-center border-b border-zinc-200 pb-5 mb-5 lg:overflow-x-hidden  overflow-x-scroll scrollbar ${
                                wishlist.length === index + 1
                                    ? "border-none mb-10"
                                    : ""
                            }`}
                        >
                            <div className="shrink-0 lg:w-96 w-80 flex items-center justify-start">
                        ...
                        >
                            <div className="shrink-0 lg:w-96 w-80 flex items-center">
                                ...
                                <div>
                                    ...
                                    <div className="text-sm opacity-50 mb-1">
                                        {item.collection.attributes.map(
                                            (attr, ind) => {
                                                return attr.attribute.code ===
                                                    "color" ? (
                                                    <div>
