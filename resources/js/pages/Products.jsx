...
const Products = ({seo}) => {
  ...
  const [selectedItems, setSelectedItems] = useState(appliedFilters.hasOwnProperty('subcategory') ? appliedFilters['subcategory']: []);
      ...
      <Layout seo={seo}>
          <>
              <div className="relative wrapper py-40  ">
                  <button onClick={() => setShowFilters(true)} className="bold text-lg ">
              ...
              >
                  ...
                  <div className="w-4/5 flex flex-col items-start justify-between h-full ">
                      ...
                      <div className="flex items-center justify-start  mt-10 pb-5 whitespace-nowrap">
                          ...
                          <button onClick={clearFilter} className="underline ml-5">Clear filter</button>
                      </div>
                  </div>
              </div>
          </>
